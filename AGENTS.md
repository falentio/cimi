...
- For local development authentication, read and follow [docs/DEV-LOGIN.md](docs/DEV-LOGIN.md).
...
- need an source code access for 3rd party library? plain `git clone` (never a submodule), vendored at `./docs/vendor/{gh,gl,bb,etc}/{orgname}/{reponame}/{ref}/`, gitignored (see `docs/vendor/README.md`, read README.md).
