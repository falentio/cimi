...
| ------------------------- | ---------------- | --------------------------------------------------------------------------- |
| `id`                      | `SId`            | Funnel identifier generated by Cimi's in-house ID generator.                |
...
| --- | ----------------- | ------ | ------------------------- | ------------- | ------- |
| Q1  | `listFunnels`     | GET    | `/funnel/listFunnels`     | authenticated | query   |
| Q2  | `getFunnel`       | GET    | `/funnel/getFunnel`       | authenticated | query   |
| Q3  | `getFunnelReport` | GET    | `/funnel/getFunnelReport` | authenticated | query   |
| C1  | `createFunnel`    | POST   | `/funnel/createFunnel`    | admin         | command |
| C2  | `updateFunnel`    | POST   | `/funnel/updateFunnel`    | admin         | command |
| C3  | `archiveFunnel`   | POST   | `/funnel/archiveFunnel`   | admin         | command |

## 4. Queries

### Q1: `GET /funnel/listFunnels` — `listFunnels`
...
### Q2: `GET /funnel/getFunnel` — `getFunnel`
...
### Q3: `GET /funnel/getFunnelReport` — `getFunnelReport`
...
### C1: `POST /funnel/createFunnel` — `createFunnel`
...
### C2: `POST /funnel/updateFunnel` — `updateFunnel`
...
### C3: `POST /funnel/archiveFunnel` — `archiveFunnel`
