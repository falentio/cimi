...
| ------------------------- | ----------------- | ----------------------------------------------------------------------------------- |
| `id`                      | `SId`             | Goal identifier generated by Cimi's in-house ID generator.                          |
...
| --- | --------------- | ------ | --------------------- | ------------- | ------- |
| Q1  | `listGoals`     | GET    | `/goal/listGoals`     | authenticated | query   |
| Q2  | `getGoal`       | GET    | `/goal/getGoal`       | authenticated | query   |
| Q3  | `getGoalReport` | GET    | `/goal/getGoalReport` | authenticated | query   |
| C1  | `createGoal`    | POST   | `/goal/createGoal`    | admin         | command |
| C2  | `updateGoal`    | POST   | `/goal/updateGoal`    | admin         | command |
| C3  | `archiveGoal`   | POST   | `/goal/archiveGoal`   | admin         | command |

## 4. Queries

### Q1: `GET /goal/listGoals` — `listGoals`
...
### Q3: `GET /goal/getGoalReport` — `getGoalReport`
...
### C1: `POST /goal/createGoal` — `createGoal`
...
### C2: `POST /goal/updateGoal` — `updateGoal`
...
### C3: `POST /goal/archiveGoal` — `archiveGoal`
